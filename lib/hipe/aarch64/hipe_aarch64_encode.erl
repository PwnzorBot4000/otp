...
ldstr_unscaled_form(Size, V, Opc, Imm9, Rn, Rt) ->
  ?BF(31,30,Size) bor ?BF(29,27,2#111) bor ?BIT(26,V) bor ?BF(25,24,2#00) bor ?BF(23,22,Opc) bor ?BIT(21,0) bor ?BFS(20,12,Imm9) bor ?BF(11,10,2#00) bor ?BF(9,5,Rn) bor ?BF(4,0,Rt).
